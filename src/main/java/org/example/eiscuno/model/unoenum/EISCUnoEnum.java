...
public enum EISCUnoEnum {
    ...
    RESERVE_BLUE("cards-uno/reverse_blue.png"),
    RESERVE_YELLOW("cards-uno/reverse_yellow.png"),
    RESERVE_GREEN("cards-uno/reverse_green.png"),
    RESERVE_RED("cards-uno/reverse_red.png"),
